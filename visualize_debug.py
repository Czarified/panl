...
from panelyze.analysis.postproc import get_stress_field
...
def visualize_stress():
    ...
    bc_type[40:42] = 1; bc_value[40:42] = 0.0
    # Center of Top edge (ele 100): idx 200 (u=0)
    bc_type[200] = 1; bc_value[200] = 0.0
    ...
    # Internal profile
    pts = np.array([[25.0, 50.0], [40.0, 50.0], [50.0, 50.0], [60.0, 50.0], [75.0, 50.0]])
    stresses = solver.compute_stress(pts, u, t)
    print(f"Sigma_xx profile along Y=50:")
    print(stresses[:, 0])
    print(f"Expected: Uniform 100.0")
